$(document).ready(function () {
  let employees = [
    ...
    { id: 4, name: "Diana", role: "QA Engineer", email: "diana@example.com" },
    { id: 5, name: "Ethan", role: "DevOps", email: "ethan@example.com" },
    { id: 6, name: "Fiona", role: "HR", email: "fiona@example.com" },
    { id: 7, name: "George", role: "Support", email: "george@example.com" },
    { id: 8, name: "Hannah", role: "Intern", email: "hannah@example.com" }
  ];
